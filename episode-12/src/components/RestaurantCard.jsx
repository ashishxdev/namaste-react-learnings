...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="m-4 w-[260px] bg-white rounded-2xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
...
export const withVegLabel = (RestaurantCardr) => {
    return (props) => {
        return (
